-- WeConnect complete Supabase setup script
-- Run this whole file in Supabase SQL Editor.
-- It is safe to run again for setup/repair because tables, functions, indexes,
-- and seed inserts are written to be repeatable, and policies are dropped/recreated.
--
-- Optional after running:
-- replace ADMIN_EMAIL_HERE at the bottom and run that update to make your first admin.
...
-- Optional: run this after you sign up with your admin email in the app.
-- Replace ADMIN_EMAIL_HERE before running.
-- update public.profiles
